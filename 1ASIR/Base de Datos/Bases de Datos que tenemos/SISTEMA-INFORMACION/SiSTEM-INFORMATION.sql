...
Cod_Rango varchar(20) not null,
Cod_Campeon varchar(20) not null,
constraint Rango_fk foreign key (Cod_Rango) references Rango(Cod_rango),
constraint Campeones_fk foreign key (Cod_Campeon) references Campeones(Cod_Campeon),
...
constraint partida_id foreign key (Cod_Partida) references Partida(Cod_Partida),
primary key(fecha) 
)engine=InnoDB;
